...
def serve_model(model_checkpoint_path_arg: str):
    dlinear_app = DLinearModelServe.bind(
    ...
    print(f"  Prediction endpoint: http://127.0.0.1:8000/predict_dlinear/predict")
    print(f"  Sequence length endpoint: http://127.0.0.1:8000/predict_dlinear/seq_len")
